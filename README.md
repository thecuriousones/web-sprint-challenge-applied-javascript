...
2. What is an event?
    It's the user interations with a site.
3. What is an event listener?
    It's tracking process and subsequent action taken when an event is set in motion.
4. Why would we convert a NodeList into an Array?
    We do it to use the other array methods outside of forEach on that particular data set.
5. What is a component?
    It's a combination of either HTML, CSS, or JavaScript used for reuse in a website or application.
