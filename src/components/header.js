...
const headerAppender = (selector) => {
  ...
  const headerCom = document.querySelector(selector);
  headerCom.appendChild(Header('Lambda Times', 'April, 18, 2021', '54*'));
}

console.log(Header('Lambda Times', 'April, 18, 2021', '54*'))
